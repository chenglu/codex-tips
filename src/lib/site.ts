...
export const SITE_AUTHOR = "Chenglu";
export const SITE_LANG = "zh-CN";
export const DEFAULT_SITE_URL = "https://chenglu.github.io/codex-tips";
export const DEFAULT_BASE_PATH = "/codex-tips/";

export const DEFAULT_TITLE = "Codex Tips · 现场手册";

...
<h1>OpenAI Codex<br/>实用技巧 <em>手册</em></h1>
<p class="lede">按使用场景整理 CLI、桌面端、IDE 与 Cloud 的常用技巧，涵盖提示、配置、Skills、MCP 与自动化。查找操作方法、复制模板，或阅读相关资料。</p>
...
<p>这里整理 OpenAI Codex 在 CLI、桌面端、IDE 扩展和 Cloud 中的使用技巧。内容来自官方文档与社区资料，可按场景检索，并附有来源链接。</p>
<p>不同版本的命令和配置可能有所变化，使用时请参考 <a href="https://developers.openai.com/codex" target="_blank" rel="noreferrer">developers.openai.com/codex</a> 和本机 <code>/help</code> 为准。</p>
<h2>怎么用</h2>
<ul>
...
按场景收录 CLI、桌面端、IDE 与 Cloud 上的实用技巧。
